...
This document owns the stable obligations for developing Ecosym. Current tools
...
Architecture that exists only to protect Ecosym from hypothetical future choices
