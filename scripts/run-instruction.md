...
You have three subagents. Use them rather than doing everything yourself:

- **scout** — gathering facts: schemas, file listings, where something is
  defined. Fast and cheap; prefer it over doing lookups inline.
- **review** — blocking defects, before committing anything trust-bearing.
- **critic** — whether the code is well made, once it works.
